...
Crossdevice tracking - omnichannel
 ...
 - [Guide to Cross device tracking with User Id in Google Analytics](https://www.optimizesmart.com/complete-guide-cross-device-tracking-user-id-google-analytics/)
...
###
 ...
 - [Скрипт для нового Google Search Analytics API позволяет хранить данные сайта на собственном сервере](http://www.searchengines.ru/news/archives/skript_dlya_nov.html)
 - [12 лучших сервисов для веб-аналитики, spark.ru](http://spark.ru/startup/changeagain-me/blog/10624/12-luchshih-servisov-dlya-veb-analitiki)
 - [Аналитика контекстной рекламы. Фишки, сервисы, подходы, searchengines.ru](http://www.searchengines.ru/articles/analitika_konte.html)
 - [Отслеживание конверсий в AdWords с помощью Google Tag Manager, spark.ru](http://spark.ru/startup/adstein/blog/10233/otslezhivanie-konversij-v-adwords-s-pomoschiu-google-tag-manager)
 - [Персонализация как инструмент: примеры Lamoda, «Евросети», «Эльдорадо» и «М.Видео»](https://vc.ru/p/25-ecommerce-personalization-samples)
 ...
 - [Google Analytics запустил вычисляемые показатели](http://www.searchengines.ru/news/archives/google_analytics_metrics.html)
...
### Google Analytics API / SDK for developers
 ...
 - [coreDevguide](https://developers.google.com/analytics/devguides/reporting/core/v3/coreDevguide)
...
#### embed-api
 - [embed-api](https://ga-dev-tools.appspot.com/embed-api/)
 - [server-side-authorization](https://ga-dev-tools.appspot.com/embed-api/server-side-authorization/)
 - [devguide](https://developers.google.com/analytics/devguides/reporting/embed/v1/devguide)
